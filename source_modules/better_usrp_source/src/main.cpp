...
class BetterUSRPSourceModule : public ModuleManager::Instance {
public:
    BetterUSRPSourceModule(std::string name) {
        this->name = name;
        ...
        sigpath::sourceManager.registerSource("BetterUSRP", &handler);
    }

    ~BetterUSRPSourceModule() {
        stop(this);
        sigpath::sourceManager.unregisterSource("BetterUSRP");
    }
...
private:
    static void menuSelected(void* ctx) {
        BetterUSRPSourceModule* _this = (BetterUSRPSourceModule*)ctx;
        ...
        flog::info("BetterUSRPSourceModule '{0}': Menu Select!", _this->name);
    }

    static void menuDeselected(void* ctx) {
        BetterUSRPSourceModule* _this = (BetterUSRPSourceModule*)ctx;
        flog::info("BetterUSRPSourceModule '{0}': Menu Deselect!", _this->name);
    }
    ...
    static void start(void* ctx) {
        ...
        _this->workerThread = std::thread(&BetterUSRPSourceModule::worker, _this);

        _this->running = true;
        flog::info("BetterUSRPSourceModule '{0}': Start!", _this->name);
    }
    ...
    static void stop(void* ctx) {
        ...
        flog::info("BetterUSRPSourceModule '{0}': Stop!", _this->name);
    }
    ...
    static void tune(double freq, void* ctx) {
        ...
        _this->freq = freq;
        flog::info("BetterUSRPSourceModule '{0}': Tune: {1}!", _this->name, freq);
    }
...
MOD_EXPORT ModuleManager::Instance* _CREATE_INSTANCE_(std::string name) {
    return new BetterUSRPSourceModule(name);
}

MOD_EXPORT void _DELETE_INSTANCE_(ModuleManager::Instance* instance) {
    delete (BetterUSRPSourceModule*)instance;
}
